...
Source0  : https://files.pythonhosted.org/packages/98/e7/ed339caf3662976949e4fdbfdf4a6db818b8d2aa1cf2b5f73af89e936bba/latexcodec-3.0.0.tar.gz
...
%prep
%setup -q -n latexcodec-3.0.0
cd %{_builddir}/latexcodec-3.0.0
pushd ..
cp -a latexcodec-3.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709761771
...
cp %{_builddir}/latexcodec-%{version}/LICENSE.rst %{buildroot}/usr/share/package-licenses/pypi-latexcodec/c6ae10266f790496c89892ab3edd10966c80ffdb || :
